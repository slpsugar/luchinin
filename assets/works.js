...
var init = () => {
	...
	row13.addEventListener('mouseover', () => {img013.style.opacity = '1';});
	row13.addEventListener('mouseout', () => {img013.style.opacity = '0.3';});

	row14.addEventListener('mouseover', () => {img014.style.opacity = '1';});
	row14.addEventListener('mouseout', () => {img014.style.opacity = '0.3';});

	row15.addEventListener('mouseover', () => {img015.style.opacity = '1';});
	row15.addEventListener('mouseout', () => {img015.style.opacity = '0.3';});

	row16.addEventListener('mouseover', () => {img016.style.opacity = '1';});
	row16.addEventListener('mouseout', () => {img016.style.opacity = '0.3';});

	row17.addEventListener('mouseover', () => {img017.style.opacity = '1';});
	row17.addEventListener('mouseout', () => {img017.style.opacity = '0.3';});

	row18.addEventListener('mouseover', () => {img018.style.opacity = '1';});
	row18.addEventListener('mouseout', () => {img018.style.opacity = '0.3';});

	row19.addEventListener('mouseover', () => {img019.style.opacity = '1';});
	row19.addEventListener('mouseout', () => {img019.style.opacity = '0.3';});

	row20.addEventListener('mouseover', () => {img020.style.opacity = '1';});
	row20.addEventListener('mouseout', () => {img020.style.opacity = '0.3';});

	row21.addEventListener('mouseover', () => {img021.style.opacity = '1';});
	row21.addEventListener('mouseout', () => {img021.style.opacity = '0.3';});

	row22.addEventListener('mouseover', () => {img022.style.opacity = '1';});
	row22.addEventListener('mouseout', () => {img022.style.opacity = '0.3';});

	row23.addEventListener('mouseover', () => {img023.style.opacity = '1';});
	row23.addEventListener('mouseout', () => {img023.style.opacity = '0.3';});
	...
	row28.addEventListener('mouseover', () => {img028.style.opacity = '1';});
	row28.addEventListener('mouseout', () => {img028.style.opacity = '0.3';});

	row29.addEventListener('mouseover', () => {img029.style.opacity = '1';});
	row29.addEventListener('mouseout', () => {img029.style.opacity = '0.3';});

	row30.addEventListener('mouseover', () => {img030.style.opacity = '1';});
	row30.addEventListener('mouseout', () => {img030.style.opacity = '0.3';});

	row31.addEventListener('mouseover', () => {img031.style.opacity = '1';});
	row31.addEventListener('mouseout', () => {img031.style.opacity = '0.3';});

	row32.addEventListener('mouseover', () => {img032.style.opacity = '1';});
	row32.addEventListener('mouseout', () => {img032.style.opacity = '0.3';});

	row33.addEventListener('mouseover', () => {img033.style.opacity = '1';});
	row33.addEventListener('mouseout', () => {img033.style.opacity = '0.3';});

	row34.addEventListener('mouseover', () => {img034.style.opacity = '1';});
	row34.addEventListener('mouseout', () => {img034.style.opacity = '0.3';});
};
init();
